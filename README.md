...
<html lang="en-us">
  <head>
    <base href="https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/volleyball%20challenge/">
      <meta charset="utf-8">
	...
	<script>
		...
		async function prepareGameAssets() {
			try {
				...
				const filesToMerge = [
					{ filename: 'VBCWebGlBuild.data', parts: 4 },
          { filename: 'VBCWebGlBuild.wasm', parts: 2 }
				];
		...
		function initUnity() {
			var loaderUrl = "VBCWebGlBuild.loader.js";
			var config = {
